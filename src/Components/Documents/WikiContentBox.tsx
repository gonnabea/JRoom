  ...
  return (
    <ContentBox>
      ...
      <Content>
        ...
        <Text>
          실시간 채팅은 당연히 화면 렌더링을 자주할 수 밖에 없습니다. 채팅을 하나 보낼 때마다 화면에
          변화된 것을 나타내주어야 하기 때문이죠. 리액트는 컴포넌트의 활용, api json data 처리, SPA
          와 같은 유용한 특성을 가지고 있으나, 이 프로젝트에서 가장 유리한 점은 리액트는 리렌더링을
          자주 해주기 용이한 구조를 가지고 있다는 것이라고 생각합니다.
        </Text>
      </Content>
    </ContentBox>
  )
